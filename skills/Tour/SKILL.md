...
1. Read `rules/Identity.md` and greet the user by name (if they've filled it in). If not, say "I see you haven't set up your identity yet — let's do that after the tour."
