...
**forge-learn** is a learning-focused personal AI setup module for the Forge ecosystem. It provides 7 skills, 1 agent, identity files, and a 7-level progression system that teaches users to customize their AI assistant.
